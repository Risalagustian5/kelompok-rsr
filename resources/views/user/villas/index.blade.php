...
<head>
    ...
    <style>
        /* CSS Tambahan buat Grid biar rapi dan mantap */
        .cards-grid {
            display: grid;
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            <div class="cards-grid">
                @forelse($villas as $v)
                <div class="card">
                    <img src="{{ $v->foto_url }}" alt="{{ $v->nama_villa }}">
                    <div class="card-body">
                        ...
                        <p style="font-weight: 700; color: #2563eb; font-size: 18px;">
                            Rp {{ number_format($v->harga, 0, ',', '.') }} <span style="font-size: 12px; font-weight: 400;">/ malam</span>
                        </p>
