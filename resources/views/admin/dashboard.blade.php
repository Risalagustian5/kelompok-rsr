...
<head>
    ...
    <title>Admin Dashboard - SAVIOUR App</title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="cards-grid">
                <div class="card">
                    <h4>Total User</h4>
                    <p style="font-size:32px;font-weight:700;color:#4f46e5;">{{ $totalUsers }}</p>
                </div>
                <div class="card">
                    <h4>Total Admin</h4>
                    <p style="font-size:32px;font-weight:700;color:#ef4444;">{{ $totalAdmins }}</p>
                </div>
                <div class="card">
                    <h4>Total Semua User</h4>
                    <p style="font-size:32px;font-weight:700;color:#10b981;">{{ $totalUsers + $totalAdmins }}</p>
                </div>
            </div>

            {{-- Tabel semua user --}}
            <div class="welcome-box" style="margin-bottom:20px;">
                <h3>Selamat Datang, Admin {{ Auth::user()->name }}! 👋</h3>
                <p>Kamu bisa mengelola semua data user dari halaman ini.</p>
            </div>
