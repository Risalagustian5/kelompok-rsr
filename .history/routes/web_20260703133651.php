...
use App\Http\Controllers\Api\VillaController;// Namespace sudah diarahkan ke folder Api
...
Route::middleware(['role:admin'])->group(function () {
    // Booking admin
    Route::get('/admin/bookings', [BookingController::class, 'adminBookings'])->name('admin.bookings.index');

    // Villa admin CRUD
    Route::get('/admin/villas', [VillaController::class, 'adminIndex'])->name('admin.villas.index');
    Route::get('/admin/villas/create', [VillaController::class, 'create'])->name('admin.villas.create');
    Route::post('/admin/villas', [VillaController::class, 'store'])->name('admin.villas.store');
    Route::get('/admin/villas/{id}/edit', [VillaController::class, 'edit'])->name('admin.villas.edit');
    Route::put('/admin/villas/{id}', [VillaController::class, 'update'])->name('admin.villas.update');
    Route::delete('/admin/villas/{id}', [VillaController::class, 'destroy'])->name('admin.villas.destroy');
});
