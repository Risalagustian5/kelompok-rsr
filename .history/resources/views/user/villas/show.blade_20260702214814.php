...
<head>
    ...
    <title>Detail Villas - {{ $villas->nama_villas }}</title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="detail-container">
                <div>
                    <img src="{{ $villa->foto_url }}" class="villa-image-large">
                ...
                <div>
                    <div class="info-card">
                        <div class="price-tag">Rp {{ number_format($villa->harga, 0, ',', '.') }} <small style="font-size: 14px;">/ malam</small></div>
